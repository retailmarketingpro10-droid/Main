          ...
          {products.map((product) => (
            <div key={product.id} className="flex flex-col rounded-2xl shadow-lg overflow-hidden bg-white hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                ...
                <div className="mt-8">
                  <a href={product.link} className="block w-full bg-gray-50 border border-gray-200 rounded-md py-2 text-sm font-semibold text-gray-700 text-center hover:bg-gray-100 transition-colors">Learn More</a>
                </div>
              </div>
            </div>
          ))}
